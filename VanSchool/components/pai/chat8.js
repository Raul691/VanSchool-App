  ...
  return (
    ...
    >
      <View style={styles.header}>
        <Image
          source={{ uri: 'https://randomuser.me/api/portraits/women/9.jpg' }}
          style={styles.avatar}
        />
        <Text style={styles.name}>Sherry Roy </Text>
      ...
      <ScrollView contentContainerStyle={styles.chatContainer}>
        ...
        <View style={[styles.chatBubble, styles.otherBubble]}>
          <Text style={styles.chatText}>Jack needs to find a sitter for the dog...</Text>
        </View>
      </ScrollView>
