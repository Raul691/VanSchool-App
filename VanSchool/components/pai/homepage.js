  ...
  return (
    <ScrollView style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.icons} onPress={() => navigation.navigate('Notificacoes')}>
      ...
      <View style={styles.paymentContainer}>
        ...
        <TouchableOpacity style={styles.paymentButton} onPress={() => navigation.navigate('Pagamentos')}>
      ...
      <View style={styles.categoriesContainer}>
        ...
        <View style={styles.categoriesRow}>
          <TouchableOpacity style={styles.icons} onPress={() => navigation.navigate('Rastrear')}>
          ...
          <TouchableOpacity style={styles.icons} onPress={() => navigation.navigate('Pagamentos')}>
      ...
      <View style={styles.driverContainer}>
        ...
        <TouchableOpacity style={styles.icons} onPress={() => navigation.navigate('PerfilM1')}>
      ...
      <View style={styles.bottomNav}>
        ...
        <TouchableOpacity style={styles.icons} onPress={() => navigation.navigate('Perfil')}>
